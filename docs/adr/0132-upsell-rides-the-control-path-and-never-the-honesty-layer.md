...
- the **no-identity-provider screen** of an install without sign-in configured (ADR-0173)
...
apiece — a fifth was added by ADR-0156 on exactly that reasoning, and a sixth
by ADR-0173.
