...
A reference written escaped, `'\${file:...}'`, as these docs said to while
[#111](https://github.com/nodqora/nodqora/issues/111) was open, still resolves; there is no need to
edit it out (ADR-0165).
